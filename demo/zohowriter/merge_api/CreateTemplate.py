...
def sample_1():
    try:
        oi_demo_obj = CreateTemplate.get_instance()
        ...
        oi_demo_obj.set_document_defaults("font_name", "Arial")
        oi_demo_obj.set_document_defaults("font_size", 12)
        ...
        oi_demo_obj.set_document_defaults("margin", margin)
